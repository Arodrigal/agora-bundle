...
use ThirdParts\AgoraBundle\Service\DTO\ThumbnailDocumentAgoraDTO;
...
class AgoraApi extends AgoraApiAbstract implements AgoraApiInterface
{
    ...
    {
        try {
            $this->logger->info('Llamada API Sharepoint para obtener el listado de los documentos de una carpeta: ');
